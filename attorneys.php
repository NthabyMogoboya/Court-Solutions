      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate pb-5 text-center">
            <h1 class="mb-3 bread">Categories of Crime</h1>
    ...
    <section class="ftco-section bg-light">
    	<div class="container-fluid">
          ...
          <div class="col-md-7 text-center heading-section ftco-animate">
            <h2 class="mb-4">Crime Category</h2>
          </div>
        </div>
        <div class="row">
        	<div class="col-lg-3 col-sm-6">
	            ...
	            <div class="flipper">
	              <div class="front" style="background-image: url(/images/Nelspruit-legal1.jpg);">
	                <div class="box">
	                  <h2>Murder</h2>
	                  <!-- <p>Civil Lawyer</p> -->
	                </div>
	              ...
	              <div class="back">
	                <!-- back content -->
	                <blockquote>
	                  <p>&ldquo;Murder is the unlawful killing of another human without justification or valid excuse, especially the unlawful killing of another human with malice aforethought. This state of mind may, depending upon the jurisdiction, distinguish murder from other forms of unlawful homicide, such as manslaughter..&rdquo;</p>
	                </blockquote>
        	...
        	<div class="col-lg-3 col-sm-6">
	            ...
	            <div class="flipper">
	              ...
	              <div class="back">
	                <!-- back content -->
	                <blockquote>
	                  <p>&ldquo;Cash-in-transit (CIT) or cash/valuables-in-transit (CVIT) is the physical transfer of banknotes, coins, credit cards and items of value from one location to another.&rdquo;</p>
	                </blockquote>
	                <div class="author d-flex">
	                  <div class="image mr-3 align-self-center">
        	...
        	<div class="col-lg-3 col-sm-6">
	            ...
	            <div class="flipper">
	              ...
	              <div class="back">
	                <!-- back content -->
	                <blockquote>
	                  <p>&ldquo; An ATM looting is a type of bank robbery in which a series of cash machines are robbed of cash. The thieves do the looting by using identity fraud to create debit cards containing other people's banking information, then they withdraw money from other peoples' bank accounts.&rdquo;</p>
	                </blockquote>
	                <div class="author d-flex">
	                  <div class="image mr-3 align-self-center">
        	...
        	<div class="col-lg-3 col-sm-6">
	            ...
	            <div class="flipper">
	              ...
	              <div class="back">
	                <!-- back content -->
	                <blockquote>
	                  <p>&ldquo;Xenophobia, from the Greek xenos, meaning "stranger" or "foreigner", and phobos, meaning "fear", is the fear or hatred of that which is perceived to be foreign or strange.&rdquo;</p>
	                </blockquote>
	                <div class="author d-flex">
	                  <div class="image mr-3 align-self-center">
